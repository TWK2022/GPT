...
parser.add_argument('--lr_start', default=0.0001, type=float, help='|初始学习率，adam算法，批量小时要减小，基准为0.0001|')
parser.add_argument('--lr_end_ratio', default=0.05, type=float, help='|最终学习率=lr_end_ratio*lr_start，基准为0.05|')
