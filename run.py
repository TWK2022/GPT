...
parser.add_argument('--model', default='qwen3', type=str, help='|模型选择|')
parser.add_argument('--model_path', default='qwen3_0.6b', type=str, help='|原模型位置|')
parser.add_argument('--save_epoch', default=5, type=int, help='|每x轮和最后一轮保存完整模型|')
parser.add_argument('--save_path', default='last.pt', type=str, help='|保存模型|')
parser.add_argument('--max_length', default=768, type=int, help='|模型输入+输出最大长度|')
...
parser.add_argument('--ema', default=False, type=bool, help='|平均指数移动(EMA)调整参数|')
